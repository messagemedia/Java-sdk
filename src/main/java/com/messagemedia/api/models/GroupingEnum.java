...
public enum GroupingEnum {
    ...
    private static TreeMap<String, GroupingEnum> valueMap = new TreeMap<String, GroupingEnum>();
    ...
    public static GroupingEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of GroupingEnum values to list of string values
     * @param toConvert The list of GroupingEnum values to convert
     * @return List of representative string values */
    public static List<String> toValue(List<GroupingEnum> toConvert) {
        if(toConvert == null)
            return null;
        List<String> convertedValues = new ArrayList<String>();
        for (GroupingEnum enumValue : toConvert) {
