...
import com.messagemedia.api.MessageMediaClient;
...
public class ControllerTestBase {
    ...
    private static MessageMediaClient client;
     ...
     * @return
     */
    protected static MessageMediaClient getClient() {
        if (client == null) {
            synchronized (clientSync) {
                if (client == null) {
                    client = new MessageMediaClient();
                }
            }
        }
        return client;
